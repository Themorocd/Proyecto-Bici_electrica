    ...
    <div class="card">
        ...
        <div class="card-body">
            <form id="formulario" onsubmit="modificarEmpresa(event)" autocomplete="off">
                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="form-floating mb-3" data-bs-toggle="tooltip" data-bs-placement="bottom" title="El cif es requerido">
                            <input id="id" class="form-control" type="hidden" name="id" value="<?php echo $data['empresa']['id'] ?>" required>
                            <input id="cif" class="form-control" type="number" name="cif" placeholder="cif" value="<?php echo $data['empresa']['cif'] ?>" required>
                            <label for="cif"><i class="fas fa-id-card"></i> CIF <span class="text-danger fw-bold">*</span> </label>
                        </div>
                    </div>
                    <div class="col-md-6">
