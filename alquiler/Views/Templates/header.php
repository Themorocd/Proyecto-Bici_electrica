...
<body class="sb-nav-fixed">
    <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
        <!-- Navbar Brand-->
        <a class="navbar-brand ps-3" href="<?php echo base_url; ?>Administracion/home">Vida Deportiva</a>
        <!-- Sidebar Toggle-->
                    ...
                    <div class="nav">
                        ...
                        <?php if ($_SESSION['id_usuario'] == 1) { ?>
                            ...
                            <a class="nav-link collapsed" href="#" data-bs-toggle="collapse" data-bs-target="#collapseVehiculos" aria-expanded="false" aria-controls="collapseVehiculos">
                                <div class="sb-nav-link-icon"><i class="fa fa-bicycle fa-2x"></i></div>
                                Bicicletas
                                <div class="sb-sidenav-collapse-arrow"><i class="fas fa-angle-down"></i></div>
                            </a>
                            <div class="collapse" id="collapseVehiculos" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    ...
                                    <a class="nav-link" href="<?php echo base_url; ?>Vehiculos">Bicicletas</a>
                                </nav>
                            </div>
                        <?php } ?>
